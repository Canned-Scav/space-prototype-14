...
// rmc-edit: removed using _RMC14.Entrenching, _RMC14.Power, _RMC14.Xenonids
...
public sealed partial class GridVehicleMoverSystem : EntitySystem
{
    ...
    private readonly record struct CollisionCandidate(
        ...
        bool IsBarricade,
        // rmc-edit: removed IsXeno - xeno system not ported, treated as regular mob
        bool IsVehicle,
        ...
        HashSet<EntityUid>? ignoredEntities = null)
    {
        ...
        foreach (var other in hits)
        {
            ...
            // rmc-edit: removed HandleSoftXenoCollision - xeno treated as regular soft mob
        ...
        out CollisionCandidate candidate)
    {
        ...
        // rmc-edit: removed isXeno - xeno treated as regular mob
        ...
        var collisionClass = ClassifyCollisionCandidate(
            ...
            isFoldable,
            hasDoor,
            false, // rmc-edit: isXeno always false
            isVehicle,
            isSmashable);
        ...
        candidate = new CollisionCandidate(
            ...
            mob,
            isBarricade,
            // rmc-edit: IsXeno removed from struct
            isVehicle,
            isUnpoweredDoor);
    ...
    // rmc-edit: removed HandleSoftXenoCollision method - xeno treated as regular soft mob

    // rmc-edit: removed ShouldBlockXeno method - requires RMCSizeStunSystem
    ...
    private bool TryGetDoorPowered(EntityUid target, out bool powered)
    {
        ...
        // rmc-edit: removed RMCPowerReceiverComponent check - RMC power system not ported
        powered = false;
        return false;
    }
    ...
    // rmc-edit: removed IsBlockingVehicleMob method - requires XenoComponent check
