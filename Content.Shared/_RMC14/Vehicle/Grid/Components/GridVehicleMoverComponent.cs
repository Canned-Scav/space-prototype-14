...
// rmc-edit: removed using Content.Shared._RMC14.Stun (RMCSizes used for xeno push/block - not ported)
...
public sealed partial class GridVehicleMoverComponent : Component
{
    ...
    // rmc-edit: removed XenoBlockMinimumSize (RMCSizes) - xeno block not ported

    /// <summary>
    /// whether xenos are allowed to push this vehicle
    /// </summary>
    // rmc-edit: CanXenosPush kept for data-compat but has no effect
    [DataField, AutoNetworkedField]
    public bool CanXenosPush = true;

    // rmc-edit: removed XenoPushMinimumSize (RMCSizes) - xeno push not ported
