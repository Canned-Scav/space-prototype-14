...
// rmc-edit: removed using Content.Shared._RMC14.Marines.Skills (skill checks not ported)
...
public sealed partial class VehicleEnterComponent : Component
{
    ...
    // rmc-edit: removed MaxXenos - xeno tracking not ported
...
{
    // rmc-edit: removed SkillWhitelist Skills field (Marines.Skills not ported)
}
