// rmc-edit: Ported from RMC14. This is the base SS14 VehicleSystem extended for RMC14 grid vehicle support.
...
public sealed partial class VehicleSystem : EntitySystem
{
    ...
    public bool TrySetOperator(Entity<VehicleComponent> entity, EntityUid? uid, bool removeExisting = true)
    {
        ...
        if (entity.Comp.Operator is { } currentOperator &&
            TryComp<VehicleOperatorComponent>(currentOperator, out var currentOperatorComponent))
        {
            ...
            RemCompDeferred<Content.Shared._RMC14.Vehicle.Grid.Components.GridVehicleOperatorComponent>(currentOperator);
        }
        ...
        if (uid != null)
        {
            ...
            {
                EnsureComp<Content.Shared._RMC14.Vehicle.Grid.Components.GridVehicleMoverComponent>(entity.Owner);
                EnsureComp<Content.Shared._RMC14.Vehicle.Grid.Components.GridVehicleOperatorComponent>(uid.Value);
