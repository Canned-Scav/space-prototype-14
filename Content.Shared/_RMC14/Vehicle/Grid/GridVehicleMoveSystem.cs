...
// rmc-edit: removed using _RMC14.Stun, _RMC14.Power, _RMC14.Xenonids
...
public sealed partial class GridVehicleMoverSystem : EntitySystem
{
    ...
    // rmc-edit: removed _rmcPower (SharedRMCPowerSystem) and _size (RMCSizeStunSystem)
    ...
    // rmc-edit: removed _activeXenoPushers dictionary - xeno push not ported
    ...
    private void OnMoverShutdown(Entity<GridVehicleMoverComponent> ent, ref ComponentShutdown args)
    {
        ...
        // rmc-edit: removed _activeXenoPushers.Remove (xeno push not ported)
    }
    ...
    {
        // rmc-edit: removed xeno operator check - xeno system not ported
        if (!args.CanRun)
            return;
    }
