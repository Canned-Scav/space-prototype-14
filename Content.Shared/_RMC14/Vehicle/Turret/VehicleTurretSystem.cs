...
public sealed class VehicleTurretSystem : EntitySystem
{
        ...
        ref AttemptShootEvent args)
    {
        ...
        // rmc-edit: FromCoordinates is nullable in Goob's AttemptShootEvent
        if (args.FromCoordinates is not { } fromCoords)
            return;
        var originMap = _transform.ToMapCoordinates(fromCoords);
        ...
        // rmc-edit: record structs in C# can't use 'with' on ref parameters; mutate directly
        args.ToCoordinates = adjustedTarget;
    }
