...
// rmc-edit: removed using Content.Shared._RMC14.Weapons.Ranged.IFF (GetIFFGunUserEvent not needed)
...
public sealed partial class VehicleWeaponsSystem : EntitySystem
{
    ...
    // rmc-edit: removed SkillsSystem _skills - Marines.Skills not ported
    ...
    public override void Initialize()
    {
        ...
        // rmc-edit: removed GetIFFGunUserEvent subscription - IFF not needed for Goob
    ...
    private void OnWeaponSeatStrapAttempt(Entity<VehicleWeaponsSeatComponent> ent, ref StrapAttemptEvent args)
    {
        ...
        // rmc-edit: removed skill check - anyone can operate vehicle weapons
    }
    ...
    // rmc-edit: removed OnTurretGetIFFGunUser - GetIFFGunUserEvent not needed for Goob IFF
